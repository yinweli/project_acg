...
public class EditorDataGame : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		GUILayout.Label(Target.Language.ToString(), GUILayout.Width(150.0f));
		GUILayout.EndHorizontal();
		GUILayout.BeginHorizontal("box");
		GUILayout.Label("StageTime", GUILayout.Width(150.0f));
		GUILayout.Label(Target.iStageTime.ToString(), GUILayout.Width(150.0f));
		GUILayout.EndHorizontal();
		GUILayout.BeginHorizontal("box");
		GUILayout.Label("Kill", GUILayout.Width(150.0f));
		GUILayout.Label(Target.iKill.ToString(), GUILayout.Width(150.0f));
		GUILayout.EndHorizontal();
		GUILayout.BeginHorizontal("box");
		GUILayout.Label("Alive", GUILayout.Width(150.0f));
		GUILayout.Label(Target.iAlive.ToString(), GUILayout.Width(150.0f));
		GUILayout.EndHorizontal();
		GUILayout.BeginHorizontal("box");
		GUILayout.Label("Dead", GUILayout.Width(150.0f));
		GUILayout.Label(Target.iDead.ToString(), GUILayout.Width(150.0f));
		GUILayout.EndHorizontal();
		GUILayout.BeginHorizontal("box");
		GUILayout.Label("Position", GUILayout.Width(150.0f));
		GUILayout.Label(Target.iRoad.ToString(), GUILayout.Width(150.0f));
		GUILayout.EndHorizontal();
		GUILayout.BeginHorizontal("box");
		GUILayout.Label("Victory", GUILayout.Width(150.0f));
		GUILayout.Label(Target.bVictory.ToString(), GUILayout.Width(150.0f));
		GUILayout.EndHorizontal();
		GUILayout.BeginHorizontal("box");
		GUILayout.Label("RunSpeed", GUILayout.Width(150.0f));
		GUILayout.Label(Target.fRunDouble.ToString(), GUILayout.Width(150.0f));
		GUILayout.EndHorizontal();
